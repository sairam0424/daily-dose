...
- **Status**: active — flagged in `docs/adr/0004-enable-cron-automation-and-vercel-deployment.md`'s Update section; not yet empirically verified against a real failure (no real workflow run has failed yet to trigger the step).
