...
*(none yet — the cross-cutting issues found during Phase 7 reconciliation (aspirational docs drift, ConfigProtection on tsconfig.json) were logged as `agent_learning.md` corrections, not code anti-patterns — see this file's own `agent_learning.md` and `../Not-Humans-Lab/agent_learning.md`)*
