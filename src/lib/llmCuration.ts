...
function buildPrompt(items: ScorableItem[]): string {
  ...
  return [
    ...
    "",
    "Write the analysis in plain, direct English for a technically literate reader who may not know this specific subfield - prefer everyday words over jargon whenever an equally precise plain-English alternative exists, and prefer shorter sentences over long, clause-heavy ones. Do not achieve this by omitting, softening, or hedging any technical claim, number, or nuance - if something is genuinely complex, explain it plainly rather than cutting it.",
    "",
